...
public class SdivInstruction extends Instruction{
//<result> = sdiv <ty> <op1>, <op2>
    Value result;
    Value.Type type;
    Value operand1;
    Value operand2;
    public SdivInstruction(BasicBlock basicBlock, Value storage, Value.Type type, Value operand1, Value operand2) {
        super(Operator.Div, basicBlock);
        this.result = storage;
        this.type = type;
